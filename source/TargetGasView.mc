...
class TargetGasView extends Ui.View {
    ...
    function calculateBlend() {
        ...
        if (!GasBlendValidator.validateTopUp()) {
        ...
        System.println("===== GAS BLEND INPUT =====");
        ...
        System.println(
            "Start pressure: " +
            GasBlendData.startPressure.format("%d")
        );
        ...
        System.println(
            "Final pressure: " +
            GasBlendData.finalPressure.format("%d")
        );
        ...
        GasBlendData.drainTo =
            (drainValue as Lang.Numeric).toFloat();
        ...
        System.println("===== GAS BLEND RESULT =====");
        ...
        System.println(
            "Drain to: " +
            GasBlendData.drainTo.format("%.1f")
        );
